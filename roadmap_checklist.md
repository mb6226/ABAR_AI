...
- [x] 1.1 تعیین اهداف و قابلیت‌های مورد نیاز (انجام شده در: project_management/requirements/requirements.md)
- [x] 1.2 انتخاب تکنولوژی‌ها و ابزارها (انجام شده در: project_management/requirements/requirements.md)
- [x] 1.3 تحلیل ریسک و فرصت‌ها (انجام شده در: project_management/requirements/requirements.md)
- [x] 1.4 تهیه مستندات اولیه (انجام شده در: project_management/requirements/requirements.md)
